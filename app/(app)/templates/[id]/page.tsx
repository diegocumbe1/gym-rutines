...
function ExerciseRow({
  ...
  return (
    <li className="crystal-surface space-y-3 rounded-2xl p-4">
      <div className="flex items-start justify-between gap-2">
        <div className="flex min-w-0 gap-3">
          <label className="mt-1 flex size-5 shrink-0 items-center justify-center rounded border border-white/10 bg-surface-2">
            <input
              type="checkbox"
